...
#'
#' \eqn{f\left(x\right)=\frac{\lambda}{\sigma}\left[e^{-\left(-\left(\frac{x-\mu}{\sigma}\right)+e^{\left(\frac{x-\mu}{\sigma}\right)}\right)}\right]\left[1-e^{-e^{\left(\frac{x-\mu}{\sigma}\right)}}\right]^{\lambda-1}}
#'
