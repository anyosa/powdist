#' Power gumbel of minimum value distribution
#'
#' Density function for the power gumbel of minimum value distribution with parameters mu, sigma and lambda.
...
#' Power gumbel of minimum value distribution
#'
#' Distribution function for the power gumbel of minimum value distribution with parameters mu, sigma and lambda.
...
#' Power gumbel of minimum value distribution
#'
#' Quantile function for the power gumbel of minimum value distribution with parameters mu, sigma and lambda.
...
#' @examples
#' qpgmiv(0.2, 1, 3, 4)
qpgmiv <- function(p, lambda, mu = 0, sigma = 1){
...
#' Power gumbel of minimum value distribution
#'
#' Random generation for the power gumbel of minimum value distribution with parameters mu, sigma and lambda.
