...
#'
#' \eqn{f\left(x\right)=\frac{\lambda}{\sigma}\left[\frac{e^{-\left(\frac{x-\mu}{\sigma}\right)^{2}}}{\sqrt{2\pi}}\right]\left[\Phi\left(\left(\frac{x-\mu}{\sigma}\right)\right)\right]^{\lambda-1}}
#'
