...
#' @details The power Gumbel of maximum value distribution has density
#'
#' \eqn{f\left(x\right)=\frac{\lambda}{\sigma}\left[e^{-\left(\left(\frac{x-\mu}{\sigma}\right)+e^{-\left(\frac{x-\mu}{\sigma}\right)}\right)}\right]\left[e^{-e^{-\left(\frac{x-\mu}{\sigma}\right)}}\right]^{\lambda-1}}
#'
...
#' dpgmav(1, 1, 3, 4)
#' @export
dpgmav <- function(x, lambda = 1, mu = 0, sigma = 1, log = FALSE){
